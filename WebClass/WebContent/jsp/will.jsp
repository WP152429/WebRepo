...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h1 class="display-3">Will</h1>
			<p class="lead">Things I like to do.</p>
			<hr class="my-4">
			...
			<div id="accordion" role="tablist">
				<div class="card">
					<div class="card-header" role="tab" id="headingOne">
						<h5 class="mb-0">
							<a data-toggle="collapse" href="#collapseOne"
								aria-expanded="true" aria-controls="collapseOne"> Playing
								game </a>
						</h5>
					</div>
					<div id="collapseOne" class="collapse" role="tabpanel"
						...
						<div class="card-body">
							<p>What could be more interesting then playing a nice game?</p>
							<p>And some dummy texts.</p>
							<p>One morning, when Gregor Samsa woke from troubled dreams,
								...
								thought. It wasn't a dream. His room, a proper human room
								...
								sleeping on his right, and in his present state couldn't get
								into that position. However hard he threw himself onto his
								right, he always rolled back to where he was. He must have tried
								it a hundred times, shut his eyes so that he wouldn't have to
								look at the floundering legs, and only stopped when he began to
								feel a mild, dull pain there that he had never felt before. "Oh,
								...
								on top of that there's the curse of travelling, worries about
								...
								position. "Getting up early all the time", he thought, "it makes
								you stupid.</p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header" role="tab" id="headingTwo">
						<h5 class="mb-0">
							<a class="collapsed" data-toggle="collapse" href="#collapseTwo"
								aria-expanded="false" aria-controls="collapseTwo"> Sleeping
							</a>
						</h5>
					</div>
					<div id="collapseTwo" class="collapse" role="tabpanel"
						...
						<div class="card-body">
							<p>When I return to my home, I usually sleep.</p>
							<p>Dummy texts again!</p>
							<p>One morning, when Gregor Samsa woke from troubled dreams,
								he found himself transformed in his bed into a horrible vermin.
								He lay on his armour-like back, and if he lifted his head a
								little he could see his brown belly, slightly domed and divided
				...
				<div class="card">
					<div class="card-header" role="tab" id="headingThree">
						<h5 class="mb-0">
							<a class="collapsed" data-toggle="collapse" href="#collapseThree"
								aria-expanded="false" aria-controls="collapseThree"> Doing
								nothing </a>
						</h5>
					</div>
					<div id="collapseThree" class="collapse" role="tabpanel"
						...
						<div class="card-body">
							<p>Yes. Doing nothing is a really nice thing to do!</p>
							<p>Texts!!!</p>
							<p>One morning, when Gregor Samsa woke from troubled dreams,
								he found himself transformed in his bed into a horrible vermin.
								He lay on his armour-like back, and if he lifted his head a
